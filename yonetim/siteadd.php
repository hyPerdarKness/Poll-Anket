...
$kayit = $db->prepare("insert into white_list set link=?"); $kayit->execute(array($_POST['link']));

echo '<div class="alert alert-success">Site adresi eklendi...</div>'; echo '<meta http-equiv="refresh" content="2">'; } } ?>
<form method="post">		
		<div class="control-group">											
			<label class="control-label">Site Adresi</label>
			<div class="controls">
			<input type="text" class="span6" name="link" placeholder="example.com">
